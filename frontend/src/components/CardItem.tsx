...
export function CardItem({ card, boardId }: Props) {
  ...
  return (
    <div
      ...
      className="bg-white rounded-lg shadow-sm border border-gray-200 px-3 py-2 text-sm text-gray-800 hover:shadow-md hover:border-blue-300 transition-all cursor-pointer"
    >
